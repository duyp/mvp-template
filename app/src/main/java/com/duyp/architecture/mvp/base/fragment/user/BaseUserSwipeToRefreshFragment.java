 ...
 * Base Fragment with Swipe to refresh layout IN {@link com.duyp.architecture.mvp.dagger.scopes.UserScope}
 * All child fragments 's layout must have {@link SwipeRefreshLayout} with id = <b>srl</b>
 */

public abstract class BaseUserSwipeToRefreshFragment<V extends BaseView, P extends BaseUserPresenter<V>>
        extends BaseUserPresenterFragment<V, P> implements SwipeRefreshLayout.OnRefreshListener, UiRefreshable {
